...
<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet"/>
    ...
    <table id="title">
	 ...
	 <xsl:sort select="ID"/>
				...
				<tr>
				<td><p class="simple" id="temp_value">21 ºC</p></td>
				</tr>
				</table>
				</xsl:if>

				<xsl:if test="RefDevicetype=4"><!--Fire sensor-->
				<table class="devices" on_fire="false" category="{RefDevicetype}" id="{ID}" name="{Name}">
				...
				<tr>
				<td><p class="simple" id="fire_alarm">OFF</p></td>
				</tr>
				</table>
				</xsl:if>     
    <!-- rest of the table-->
